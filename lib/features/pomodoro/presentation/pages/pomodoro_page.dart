          ...
          appBar: AppBar(
            ...
            actions: [
              IconButton(
                ...
                onPressed: () => _openSettings(context, bloc, state),
              ),
            ],
          ),
          body: Center(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Wrap(
                    ...
                    children: [
                      FilledButton.tonal(
                        onPressed: isRunning ? null : bloc.start,
                        child: const Text('Start'),
                      ),
                      FilledButton.tonal(
                        onPressed: isRunning ? bloc.pause : null,
                  ...
                  Text('Foco: ${state.workMinutes} min • Pausa: ${state.breakMinutes} min',
